...
namespace retail_backend.Migrations
{
    ...
    [Migration("20260115160855_AddLocationWithStockRelations")]
    partial class AddLocationWithStockRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Stock.Entities.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domains.Stock.Entities.ProductStock", b =>
                {
                    ...
                    b.HasIndex("ProductPackagingId", "OrganizationId", "LocationId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domains.Stock.Entities.Location", b =>
                {
                    b.HasOne("Domains.Stock.Entities.Location", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Domains.Stock.Entities.ProductStock", b =>
                {
                    b.HasOne("Domains.Stock.Entities.Location", "Location")
                        .WithMany()
