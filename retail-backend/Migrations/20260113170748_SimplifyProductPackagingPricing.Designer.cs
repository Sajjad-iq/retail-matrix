...
namespace retail_backend.Migrations
{
    ...
    [Migration("20260113170748_SimplifyProductPackagingPricing")]
    partial class SimplifyProductPackagingPricing
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Products.Entities.ProductStock", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domains.Products.Entities.StockBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domains.Products.Entities.StockMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domains.Products.Entities.StockBatch", b =>
                {
                    b.HasOne("Domains.Products.Entities.ProductStock", "ProductStock")
                        .WithMany("Batches")
