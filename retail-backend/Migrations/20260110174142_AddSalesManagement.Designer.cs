...
namespace retail_backend.Migrations
{
    ...
    [Migration("20260110174142_AddSalesManagement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Entities.Payment", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Amount", "Domains.Entities.Payment.Amount#Price", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Domains.Entities.ProductPackaging", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("CostPrice", "Domains.Entities.ProductPackaging.CostPrice#Price", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("SellingPrice", "Domains.Entities.ProductPackaging.SellingPrice#Price", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Weight", "Domains.Entities.ProductPackaging.Weight#Weight", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Domains.Entities.ProductStock", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domains.Entities.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("AmountPaid", "Domains.Entities.Sale.AmountPaid#Price", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("GrandTotal", "Domains.Entities.Sale.GrandTotal#Price", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("TotalDiscount", "Domains.Entities.Sale.TotalDiscount#Price", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Domains.Entities.SaleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("LineTotal", "Domains.Entities.SaleItem.LineTotal#Price", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("UnitPrice", "Domains.Entities.SaleItem.UnitPrice#Price", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Domains.Entities.Payment", b =>
                {
                    b.HasOne("Domains.Entities.Sale", null)
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("Domains.Entities.ProductStock", b =>
                {
                    b.HasOne("Domains.Entities.ProductPackaging", "Packaging")
                        .WithMany()
