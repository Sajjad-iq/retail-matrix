...
using PhoneVO = Domains.Users.ValueObjects.Phone;
using DomainNameVO = Domains.Shared.ValueObjects.DomainName;

namespace Domains.Organizations.Entities;
...
public class Organization : BaseEntity
{
        ...
        string? logoUrl = null)
    {
        ...
        var orgName = NameVO.Create(name, minLength: 2, maxLength: 200);
        var orgDomain = DomainNameVO.Create(domain);
        var orgPhone = PhoneVO.Create(phone);
