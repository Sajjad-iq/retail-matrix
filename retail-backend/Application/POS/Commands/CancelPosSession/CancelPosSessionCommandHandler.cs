...
public class CancelPosSessionCommandHandler : IRequestHandler<CancelPosSessionCommand, bool>
{
    private readonly ISaleRepository _saleRepository;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public CancelPosSessionCommandHandler(
    ...
    public async Task<bool> Handle(CancelPosSessionCommand request, CancellationToken cancellationToken)
    {
