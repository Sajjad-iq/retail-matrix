...
export const columns: ColumnDef<ProductWithPackagingsDto>[] = [
    ...
    },
    {
        ...
        header: 'سعر البيع',
        cell: ({ row }) => {
            // Display price of the first packaging unit or a range if multiple
            const packagings = row.original.packagings;
            if (!packagings || packagings.length === 0) return <span className="text-muted-foreground text-sm">-</span>;
