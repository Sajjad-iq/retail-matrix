...
export const createStockSchema = z.object({
    ...
    initialBatchNumber: z.string().optional().or(z.literal('')),
    initialQuantity: z.coerce.number().min(0, 'الكمية يجب أن لا تكون سالبة').optional(),
    initialExpiryDate: z.union([z.string(), z.date()]).optional().transform(val => {
    ...
    initialCostPrice: z.object({
        amount: z.coerce.number().min(0, 'السعر يجب أن لا يكون سالب'),
